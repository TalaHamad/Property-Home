...
public class AdminProfileScreenController implements Initializable
{
    @FXML
    ...
    @FXML
    private Button apartmentsButton;
    @FXML
    ...
    @FXML
    void switchToApartmentsScreen()
    {
        this.switchScreen("/FXML_Files/AdminApartmentsScreen.fxml", "Admin Apartments");
    }

    @FXML
    void switchToAppointmentsScreen()
    {
        this.switchScreen("/FXML_Files/AdminAppointmentsScreen.fxml", "Admin Appointments");
    }
    ...
    public void changeCursor(Event event)
    {
        ...
        else if (event.getSource() == this.appointmentsButton)
        {
            this.appointmentsButton.setCursor(Cursor.HAND);
        }
        else if (event.getSource() == this.apartmentsButton)
        {
            this.apartmentsButton.setCursor(Cursor.HAND);
        }
